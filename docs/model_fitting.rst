...
SpecViz includes functionality to fit models to spectra. It uses
`astropy's Models <http://docs.astropy.org/en/stable/modeling/>`_ and
`SpecUtils <https://specutils.readthedocs.io/en/latest/fitting.html>`_
to do so. The following models are available in SpecViz:
